...
\attribute{release\_date}{The date the set was released.}{Datetime}{Any valid date.}
...
\attribute{format\_type}{The type of the format (constructed, draft, etc)}{String}{Valid magic format types.}
\attribute{multiplayer}{If the format can be played by more than 2 people.}{Boolean}{Any valid boolean.}
